...
emailInput.addEventListener("input", (0, _lodashThrottleDefault.default)(saveFormValue, 500));
messageInput.addEventListener("input", (0, _lodashThrottleDefault.default)(saveFormValue, 500));
